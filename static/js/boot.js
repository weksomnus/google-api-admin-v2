...
layer.config({
	...
	if ($.get("skin-config.html", function(a) {
		...
		var a = localStorage.getItem("collapse_menu"),
			...
			l = $("body");
		"on" == a && (l.hasClass("body-small") || l.addClass("mini-navbar")), "on" == e && ($(".navbar-static-top").removeClass("navbar-static-top").addClass("navbar-fixed-top"), l.addClass("fixed-nav")), "on" == i && l.addClass("boxed-layout")
	}
});